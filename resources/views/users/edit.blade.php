        ...
        <form method="POST" action="{{ route('users.update', $user) }}">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <x-text-input id="job_title" class="mt-1 block w-full" type="text" name="job_title" :value="old('job_title', $user->job_title)" autocomplete="organization-title" />
                    <x-input-error :messages="$errors->get('job_title')" class="mt-2" />
                </div>

                <div>
                    <x-input-label for="office" :value="__('Office')" />
                    <x-text-input id="office" class="mt-1 block w-full" type="text" name="office" :value="old('office', $user->office)" autocomplete="organization" />
